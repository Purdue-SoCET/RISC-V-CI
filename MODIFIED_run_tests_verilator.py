...
def compile_asm(filepath: Type[pathlib.Path], outpath: Type[pathlib.Path],\
    ...
    compile_cmd_arr = ["riscv32-unknown-elf-gcc", 
                "-march=" + config.march + "_zicsr_zifencei_a", "-mabi=" + config.abi,
    ...
    elf_2_bin = ['riscv32-unknown-elf-objcopy', '-O', 'binary', str(outpath), 'meminit.bin']
